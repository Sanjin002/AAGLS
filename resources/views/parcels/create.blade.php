...
-->
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ClientReference" name="ClientReference" value="{{ old('ClientReference') }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="Count" name="Count" value="{{ old('Count') }}" required min="1" step="1">
                            <small class="text-muted">Must be a whole number</small>
                        </div>
                        <div class="mb-3">
                            <label for="CODAmount" class="form-label">COD Amount</label>
                            <input type="number" step="0.01" class="form-control" id="CODAmount" name="CODAmount" value="{{ old('CODAmount') }}" required min="0">
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryCity" class="form-label">Delivery City</label>
                            <input type="text" class="form-control" id="DeliveryCity" name="DeliveryCity" value="{{ old('DeliveryCity') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryContactName" class="form-label">Delivery Contact Name</label>
                            <input type="text" class="form-control" id="DeliveryContactName" name="DeliveryContactName" value="{{ old('DeliveryContactName') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryContactPhone" class="form-label">Delivery Contact Phone</label>
                            <input type="text" class="form-control" id="DeliveryContactPhone" name="DeliveryContactPhone" value="{{ old('DeliveryContactPhone') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryCountryIsoCode" class="form-label">Delivery Country ISO Code</label>
                            <input type="text" class="form-control" id="DeliveryCountryIsoCode" name="DeliveryCountryIsoCode" value="{{ old('DeliveryCountryIsoCode') }}" required maxlength="2">
                            <small class="text-muted">Must be one of: HR, SI, HU, RO, CZ, SK</small>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryName" class="form-label">Delivery Name</label>
                            <input type="text" class="form-control" id="DeliveryName" name="DeliveryName" value="{{ old('DeliveryName') }}" required>
                            <small class="text-muted">Cannot contain &lt;, &gt;, or &amp;</small>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryStreet" class="form-label">Delivery Street</label>
                            <input type="text" class="form-control" id="DeliveryStreet" name="DeliveryStreet" value="{{ old('DeliveryStreet') }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="DeliveryZipCode" class="form-label">Delivery Zip Code</label>
                            <input type="text" class="form-control" id="DeliveryZipCode" name="DeliveryZipCode" value="{{ old('DeliveryZipCode') }}" required>
